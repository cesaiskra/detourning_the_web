...
# driver.get('https://www.google.com/voice/b/0#inbox')

more_button = driver.find_element_by_class_name('layout-align-center-center')
more_button.find_element_by_tag_name('button').click()
time.sleep(1)

legacy = driver.find_element_by_css_selector('gv-nav-item[label="Legacy Google Voice"]')
legacy.click()
